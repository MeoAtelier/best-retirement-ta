        ...
        <div className="App">
          <div className="first-section">
            <div className="intro">
              ...
              <p>A full article is <a href="http://www.nzherald.co.nz/business/news/article.cfm?c_id=3&objectid=11992596">here</a>. Original data and details of the analysis are available <a href="http://insights.nzherald.co.nz/data/best-retirement-area/index.html">here</a>.</p>
            </div>
